...
export class ProjectControllerBase {
  ...
  async findManyMySecondTask(
    ...
    const results = await this.service.findMySecondTask(params.id, {
      where: query,
      select: {
        createdAt: true,
        estimation: true,
  ...
  @common.UseInterceptors(nestMorgan.MorganInterceptor("combined"))
  @common.UseGuards(basicAuthGuard.BasicAuthGuard, nestAccessControl.ACGuard)
  @common.Post("/:id/mySecondTask")
  @nestAccessControl.UseRoles({
    resource: "Project",
    action: "update",
    possession: "any",
  })
  async createMySecondTask(
    @common.Param() params: ProjectWhereUniqueInput,
  ...
  @common.UseInterceptors(nestMorgan.MorganInterceptor("combined"))
  @common.UseGuards(basicAuthGuard.BasicAuthGuard, nestAccessControl.ACGuard)
  @common.Patch("/:id/mySecondTask")
  @nestAccessControl.UseRoles({
    resource: "Project",
    action: "update",
    possession: "any",
  })
  async updateMySecondTask(
    @common.Param() params: ProjectWhereUniqueInput,
    @common.Body() body: ProjectWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
  ...
  @common.UseInterceptors(nestMorgan.MorganInterceptor("combined"))
  @common.UseGuards(basicAuthGuard.BasicAuthGuard, nestAccessControl.ACGuard)
  @common.Delete("/:id/mySecondTask")
  @nestAccessControl.UseRoles({
    resource: "Project",
    action: "update",
    possession: "any",
  })
  async deleteMySecondTask(
    @common.Param() params: ProjectWhereUniqueInput,
    @common.Body() body: ProjectWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
